...
To find an asymptotic estimate of the parameters we throw away the measurements of $\tilde{c}_n(2)$ for small $n$ to avoid the bias of the first few measurements. The estimated parameters can be seen in table \ref{tab:estimate_parameters}. The theoretical value for $\gamma_2$ is $43/32 \approx 1.34$. As $n$ gets larger the estimate of $\gamma$ gets closer to the theoretical value.

\begin{table}[H]
    \centering
    \caption{Approximations of $\theta$ for different n. The walk length is 100 and the number of samples are $10^4$}
...
\begin{table}[H]
    \centering
    \caption{Approximations of $\theta$ for multiple runs. The walk length is 100 and the number of samples are $10^4$}
...
\begin{table}[H]
    \centering
    \caption{Variance of approximations of $\theta$ for multiple runs. The walk length is 100 and the number of samples are $10^4$}
